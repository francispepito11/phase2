...
<div class="flex h-screen bg-gray-100">
    <!-- Sidebar -->
    <div class="bg-blue-800 text-white w-64 flex-shrink-0 fixed h-full z-10">
        <div class="p-4">
        ...
        <nav class="mt-5">
            ...
            <div x-data="{ open: false }">
                <button @click="open = !open" class="w-full flex items-center px-4 py-3 hover:bg-blue-700 focus:outline-none">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clip-rule="evenodd" />
                    </svg>
                    Tech Supports
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-auto" :class="{'transform rotate-180': open}" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" />
                    </svg>
                </button>
                <div x-show="open" @click.away="open = false" class="bg-blue-900 pl-8">
                    <a href="service-requests.php" class="flex items-center px-4 py-2 hover:bg-blue-700">
                    ...
                    <a href="support-summary.php" class="flex items-center px-4 py-2 hover:bg-blue-700">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <a href="foot-tracking.php" class="flex items-center px-4 py-2 hover:bg-blue-700">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M6.625 2.655A9 9 0 0119 11a1 1 0 11-2 0 7 7 0 00-9.625-6.492 1 1 0 11-.75-1.853zM4.662 4.959A1 1 0 014.75 6.37 6.97 6.97 0 003 11a1 1 0 11-2 0 8.97 8.97 0 012.25-5.953 1 1 0 011.412-.088z" />
    ...
    <div class="ml-64 flex-1 flex flex-col min-h-screen">
        <!-- This div will be closed in the page that includes the sidebar -->
        <!-- DO NOT ADD CLOSING DIV TAG HERE -->
